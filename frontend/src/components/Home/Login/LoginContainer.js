...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="warning" onClick={() => { auth.login(() => { bypassLogin(props, 'channelOwner') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="warning" onClick={() => { auth.login(() => { bypassLogin(props, 'brandOwner') }); }}>ByPass Consumer Login</Button>{' '}
